...
// // // Middleware to catch multer errors before controller logic
// // router.post('/profile/update',isAuthenticated,imageUploadMiddleware,profileController.updateProfile);
